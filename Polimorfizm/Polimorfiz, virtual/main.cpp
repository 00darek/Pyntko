...
class Imie
{
    ...
    virtual void zwrocDane() // zwróci wszystkie dane z klasy pochodnej
    // void zwrocDane() // zwróci samo imie
    {
        cout << endl << "imie: " << imie;
    }
};
...
void zwrocDane() {Imie::zwrocDane(); Nazwisko::zwrocDane();}
};
...
void zwrocDane() {Imie::zwrocDane(); Nazwisko::zwrocDane(); Przedmiot::zwrocDane();}
};
...
void zwrocDane() {Imie::zwrocDane(); Nazwisko::zwrocDane(); Przedmiot::zwrocDane(); Klasa::zwrocDane();}
};
